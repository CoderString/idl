...
const (
	Greeter_SayHello_FullMethodName = "/helloworld.demo.Greeter/SayHello"
	Greeter_Upload_FullMethodName   = "/helloworld.demo.Greeter/Upload"
	Greeter_Download_FullMethodName = "/helloworld.demo.Greeter/Download"
)
...
func (c *greeterClient) Upload(ctx context.Context, in *CsvRequest, opts ...grpc.CallOption) (*CsvResponse, error) {
	out := new(CsvResponse)
	err := c.cc.Invoke(ctx, Greeter_Upload_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_Upload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Upload(ctx, req.(*CsvRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Greeter_Download_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(GreeterServer).Download(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "helloworld.demo.Greeter",
